...
- In the code we've provided, the popup is sitting in its final position, so you'll need to change its initial position, and then use a transition to move it back to the center.
